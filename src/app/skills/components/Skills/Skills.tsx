...
export const skillsData: SkillsData[] = [
  ...
  },
  {
    ...
    skillLogo: "/images/skills/motion-logo.png",
    label: "LIBRARY",
  ...
  },
  {
    ...
    skillLink: "git",
    description:
      "Gitの基本的なコマンドを理解しています。普段はGitHubでローカルリポジトリとリモートリポジトリを連携し、issueやPRの作成、ファイルのバージョン管理、変更履歴の追跡を行っています。また、Git worktreeを活用したパラレル開発にも取り組んでいます。",
  ...
  },
  {
    ...
    skillLink: "llm",
    description:
      "LLM（Large Language Model）を日常的に活用しており、主に「ChatGPT」「Gemini」「Claude」を使い分けています。シーンに応じて、それぞれのモデルの強みを活かすよう心がけています。最近はClaude Code/Codex CLIを活用したAI駆動開発にも取り組んでいます。",
    skillLogo: "/images/skills/llm-logo.svg",
    label: "AI",
    link: "https://github.com/modelcontextprotocol",
    viewTransitionName: "view-transition-title-llm",
    viewTransitionImage: "view-transition-img-llm",
    viewTransitionBg: "view-transition-bg-llm",
    viewTransitionLabel: "view-transition-label-llm",
  ...
  },
  {
    ...
    skillLink: "mcp",
    description:
      "MCP（Model Context Protocol）の概念を理解し、AIエージェントの能力拡張にMCPサーバーを活用しています。ZennではMCPやAIエージェントなどのAIに関する技術記事も執筆しています。",
