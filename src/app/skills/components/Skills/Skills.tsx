...
export const skillsData: SkillsData[] = [
  ...
  },
  {
    ...
    skillLink: "authjs",
    description:
      "私が開発したWebアプリ「OUTPUT QUEST ~叡智の継承者~」で、Auth.jsを使用してユーザー認証を実装しました。",
  ...
  },
  {
    ...
    skillLink: "supabase",
    description:
      "私が開発したWebアプリ「OUTPUT QUEST ~叡智の継承者~」で、Supabaseを使用してデータベースでユーザー情報を管理しました。",
  ...
  },
  {
    ...
    skillLink: "prisma",
    description:
      "私が開発したWebアプリ「OUTPUT QUEST ~叡智の継承者~」で、Prismaを使用してデータベース操作を行いました。",
  ...
  },
  {
    ...
    skillLink: "mcp",
    description:
      "MCP（Model Context Protocol）の概念を理解しています。自作MCPサーバーの実装経験があり、AIエージェントの能力拡張に活用しています。ZennにてMCPやAIエージェントに関する技術記事も執筆しています。",
