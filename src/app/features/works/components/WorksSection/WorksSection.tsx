...
export const worksData: WorksData[] = [
  ...
  },
  {
    ...
    cardDesc:
      'ゲーミフィケーションを取り入れた "RPG風学習支援Webアプリ" です。勇者と共に学びの冒険をはじめよう！',
    description:
      "「OUTPUT QUEST 叡智の継承者」は、ゲーミフィケーションを取り入れた「RPG風学習支援Webアプリ」です。Zennで記事を投稿することで、アプリ内の「勇者」が成長し、アイテムの入手、称号の獲得、仲間との出会いが待っています。ゲーミフィケーションにより学習意欲と知的好奇心を高め、楽しみながら学びとアウトプットを継続できるよう設計しました。",
    detail01:
      "　Next.js + Tailwind CSS + TypeScriptで開発し、Vercelにデプロイしています。",
    detail02:
