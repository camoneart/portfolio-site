...
export const worksData: WorksData[] = [
  {
    ...
    siteUrl: "https://aoyamadev.com/caresend/",
    role: "Coding",
    username: "demo",
    password: "demo01",
  ...
  },
  {
    ...
    skillsList: "HTML, CSS, Sass, JavaScript, Swiper, GSAP, webpack",
    siteUrl: "https://aoyamadev.com/aobotan/",
    role: "Coding",
    username: "demo",
    password: "demo02",
  ...
  },
  {
    ...
    siteUrl: "https://aoyamadev.com/tetote/",
    role: "Coding",
    username: "demo",
    password: "demo03",
  ...
  },
  {
    ...
    description:
      "私が開発したWebアプリです。RPG風のゲーミフィケーションを取り入れた学習支援アプリで、Zennで記事を投稿することでアプリ内の「勇者」が成長し、アイテムやなかまを獲得できます。アウトプットを通じて学習意欲を高め、楽しみながら自己成長を促すことを目的に開発しました。",
    detail01:
