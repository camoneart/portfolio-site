...
export const worksData: WorksData[] = [
  ...
  },
  {
    ...
    detail04:
      "　ログインページ：Clerk認証によるログイン、Zennのアカウント連携を行ったユーザーのみがアプリを利用できるようにしています。Zennと連携することにより、投稿データをアプリ内の要素に反映できます。",
    detail05:
      "　ダッシュボードページ：勇者の成長度合いを示すレベル、Zennでの投稿数、レベルアップ報酬で獲得した勇者のなかまやアイテムを確認できます。",
    detail06:
      "　投稿リストページ：Zennで投稿した記事を取得して、アプリ内で「投稿リスト」として記事を閲覧できます。",
    detail07:
      "　つよさページ：勇者の成長度合いを示すレベル、レベルアップ報酬で獲得した「称号」の確認、勇者の装備アイテムの確認、学びの記録を時系列で確認できる「冒険ログ」の確認ができます。",
    detail08:
