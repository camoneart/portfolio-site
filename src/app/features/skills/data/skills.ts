...
export const skillsData: SkillsData[] = [
  ...
  },
  {
    ...
    description: "Claude Codeの基本を理解しています。CLAUDE.mdの整備(段階的開示, AI slop回避, 電報スタイル etc...)・セキュリティ設計(permissions.deny, Hooksによる構造的ブロック etc...)・Subagents, Skillsの構築・Agent Teamsによるマルチエージェント協調・コンテキストエンジニアリング・MCP活用など、Claudeのためのハーネス構築まで取り組んでいます。",
